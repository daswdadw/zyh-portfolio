const dictionaries = {
  zh: {
    ...
    currentlyTitle: "最近在做什么",
    currentlyBody: "这段时间我主要把注意力放在自动驾驶、AI 检索系统和控制方向研究上。我喜欢那种需要一边理解原理、一边动手调通系统的事情，因为它们总会逼着我把“知道”变成“真的会”。",
    educationTitle: "教育背景",
    ...
    note4Title: "我想把这里做成什么",
    note4Body: "这个网站对我来说，不只是把经历排版出来。我更希望它像一个持续更新的个人角落，慢慢记录我做过的事、在想的问题，以及我怎么一点点成长成自己想成为的人。",
    contactTitle: "联系我",
    phoneLabel: "电话",
    emailLabel: "邮箱",
    englishLabel: "英语",
  ...
  en: {
    ...
    currentlyTitle: "What I Am Focusing On",
    currentlyBody: "Recently, most of my attention has gone into autonomous driving, AI retrieval systems, and control research. I am especially drawn to work that forces me to understand principles while also making real systems run.",
    ...
    note4Title: "What I Want This Site To Be",
    note4Body: "For me, this site is more than a formatted list of experiences. I want it to become a personal corner that keeps growing with the things I build, the problems I think about, and the person I am becoming.",
